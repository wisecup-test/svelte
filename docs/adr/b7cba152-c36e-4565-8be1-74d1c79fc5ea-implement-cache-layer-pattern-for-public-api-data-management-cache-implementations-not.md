# Implement Cache Layer Pattern for Public API Data Management: Cache Implementations Not
...
1. MUST_NOT: Cache implementations MUST NOT cache sensitive user data without explicit encryption or secure storage mechanisms

## Policy Block

- MUST_NOT Cache implementations MUST NOT cache sensitive user data without explicit encryption or secure storage mechanisms
