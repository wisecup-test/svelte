# Adopt Modular Public API Export Pattern with Explicit Re-exports: Public Exports Explicitly
...
1. MUST: All public API exports MUST be explicitly declared in dedicated entry point files (e.g., index.js, index-server.js)

## Policy Block

- MUST All public API exports MUST be explicitly declared in dedicated entry point files (e.g., index.js, index-server.js)
