# Adopt Modular Public API Export Pattern with Explicit Re-exports: Internal Implementation Files
...
1. MUST: Internal implementation files MUST reside in separate directories from public entry points (e.g., internal/, compiler/utils/)

## Policy Block

- MUST Internal implementation files MUST reside in separate directories from public entry points (e.g., internal/, compiler/utils/)
