# Establish Public API Export Contracts with Explicit Module Boundaries: Development Specific Dev
...
1. MUST: Development-specific APIs (e.g., /dev/* modules) MUST maintain contract compatibility with production equivalents while providing enhanced validation and debugging capabilities

## Policy Block

- MUST Development-specific APIs (e.g., /dev/* modules) MUST maintain contract compatibility with production equivalents while providing enhanced validation and debugging capabilities
