# Standardize Public API Export Patterns for External Integration: Modules Expose Additional
...
1. MAY: Modules MAY expose additional experimental APIs with clear deprecation or stability warnings

## Policy Block

- MAY Modules MAY expose additional experimental APIs with clear deprecation or stability warnings
