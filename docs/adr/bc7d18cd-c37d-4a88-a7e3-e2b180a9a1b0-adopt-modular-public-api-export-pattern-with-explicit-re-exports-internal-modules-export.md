# Adopt Modular Public API Export Pattern with Explicit Re-exports: Internal Modules Export
...
1. MAY: Internal modules MAY export additional utilities not exposed in public entry points for internal framework use

## Policy Block

- MAY Internal modules MAY export additional utilities not exposed in public entry points for internal framework use
