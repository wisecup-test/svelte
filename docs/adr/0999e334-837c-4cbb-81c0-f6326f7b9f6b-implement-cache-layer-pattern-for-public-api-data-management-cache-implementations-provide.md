# Implement Cache Layer Pattern for Public API Data Management: Cache Implementations Provide
...
1. MUST: Cache implementations MUST provide explicit cache invalidation mechanisms to prevent serving stale data

## Policy Block

- MUST Cache implementations MUST provide explicit cache invalidation mechanisms to prevent serving stale data
