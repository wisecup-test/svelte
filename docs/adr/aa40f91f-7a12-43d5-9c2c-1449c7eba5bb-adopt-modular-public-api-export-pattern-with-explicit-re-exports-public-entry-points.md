# Adopt Modular Public API Export Pattern with Explicit Re-exports: Public Entry Points
...
1. MUST_NOT: Public entry points MUST_NOT contain implementation logic; they MUST only re-export from internal modules

## Policy Block

- MUST_NOT Public entry points MUST_NOT contain implementation logic; they MUST only re-export from internal modules
