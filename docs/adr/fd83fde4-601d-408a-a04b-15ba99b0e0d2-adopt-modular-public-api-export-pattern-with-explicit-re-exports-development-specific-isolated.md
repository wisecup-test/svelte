# Adopt Modular Public API Export Pattern with Explicit Re-exports: Development Specific Isolated
...
1. SHOULD: Development-specific APIs SHOULD be isolated in separate modules (e.g., dev/ subdirectories) and conditionally exported

## Policy Block

- SHOULD Development-specific APIs SHOULD be isolated in separate modules (e.g., dev/ subdirectories) and conditionally exported
