# Establish Public API Export Contracts with Explicit Module Boundaries: Breaking Changes Public
...
1. SHOULD: Breaking changes to public API contracts SHOULD follow semantic versioning principles and SHOULD be accompanied by deprecation warnings in prior releases

## Policy Block

- SHOULD Breaking changes to public API contracts SHOULD follow semantic versioning principles and SHOULD be accompanied by deprecation warnings in prior releases
