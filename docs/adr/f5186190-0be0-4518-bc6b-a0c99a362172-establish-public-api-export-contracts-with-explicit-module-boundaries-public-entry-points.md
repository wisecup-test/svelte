# Establish Public API Export Contracts with Explicit Module Boundaries: Public Entry Points
...
1. MUST: Public API entry points (e.g., index.js, index-server.js) MUST serve as the sole interface for external consumers and MUST NOT expose internal implementation paths

## Policy Block

- MUST Public API entry points (e.g., index.js, index-server.js) MUST serve as the sole interface for external consumers and MUST NOT expose internal implementation paths
