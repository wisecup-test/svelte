# Adopt Modular Public API Export Pattern with Explicit Re-exports: Public Modules Use
...
1. SHOULD: Public API modules SHOULD use named exports rather than default exports to improve tree-shaking and IDE support

## Policy Block

- SHOULD Public API modules SHOULD use named exports rather than default exports to improve tree-shaking and IDE support
