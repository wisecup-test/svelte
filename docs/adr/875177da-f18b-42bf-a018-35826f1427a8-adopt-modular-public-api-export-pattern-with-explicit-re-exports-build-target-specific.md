# Adopt Modular Public API Export Pattern with Explicit Re-exports: Build Target Specific
...
1. SHOULD: Build-target-specific entry points SHOULD use descriptive suffixes (e.g., -server, -client) to indicate their intended environment

## Policy Block

- SHOULD Build-target-specific entry points SHOULD use descriptive suffixes (e.g., -server, -client) to indicate their intended environment
