# Standardize Public API Export Patterns for External Integration: Public Provide Stable
...
1. SHOULD: Public APIs SHOULD provide stable interfaces that minimize breaking changes across minor versions

## Policy Block

- SHOULD Public APIs SHOULD provide stable interfaces that minimize breaking changes across minor versions
