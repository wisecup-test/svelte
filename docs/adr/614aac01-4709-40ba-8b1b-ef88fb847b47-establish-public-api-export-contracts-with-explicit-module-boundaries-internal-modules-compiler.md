# Establish Public API Export Contracts with Explicit Module Boundaries: Internal Modules Compiler
...
1. MUST: Internal modules (e.g., /internal/*, /compiler/utils/*) MUST be clearly distinguished from public APIs through directory structure and MUST NOT be directly imported by external consumers

## Policy Block

- MUST Internal modules (e.g., /internal/*, /compiler/utils/*) MUST be clearly distinguished from public APIs through directory structure and MUST NOT be directly imported by external consumers
