# Establish Public API Export Contracts with Explicit Module Boundaries: Framework Modules Provide
...
1. MAY: Framework modules MAY provide separate entry points for different runtime environments (client, server, compiler) as long as each maintains clear contract boundaries

## Policy Block

- MAY Framework modules MAY provide separate entry points for different runtime environments (client, server, compiler) as long as each maintains clear contract boundaries
