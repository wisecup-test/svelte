<rule_activation id="41e2b54f-8ee1-4b69-ae11-1e36e57edfdb" title="Establish Public API Export Contracts with Explicit Module Boundaries: Public Modules Include" applies_to="**/*">
...
- **R-API-001** SHOULD: Public API modules SHOULD include JSDoc comments or TypeScript definitions documenting exported functions, parameters, return types, and usage examples.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of public API export contracts. All exported functions, classes, and constants must be validated against the contract specifications and verification commands before acceptance.
</enforcement>